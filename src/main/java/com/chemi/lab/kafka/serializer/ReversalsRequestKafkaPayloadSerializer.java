...
public class ReversalsRequestKafkaPayloadSerializer implements Serializer<ReversalsRequestKafkaPayload> {
    ...
    @Override
    public byte[] serialize(String topic, ReversalsRequestKafkaPayload data) {
        try {
            if (data == null) {
                return null;
            }
